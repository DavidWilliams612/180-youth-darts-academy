    ...
    <div className="min-h-screen w-full bg-180 flex flex-col text-white">
      ...
      <div className="w-full bg-black/20 border-b border-brand/20 backdrop-blur-sm">
        <div className="px-6 py-3 flex gap-6 text-sm text-white/70 overflow-x-auto">
          ...
          <a href="/learn-more/age-groups" className="text-brand-light drop-shadow-[var(--brand-glow)]">
            Age Groups
          </a>
      ...
      <header className="px-6 py-16 text-center">
        ...
        <p className="text-white/70 mt-4 max-w-2xl mx-auto">
          We welcome players of all ages and tailor sessions to suit each group.
        </p>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20 space-y-12">
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            A fun and friendly introduction to darts, focusing on coordination,
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            Developing technique, consistency, and understanding of the game while
            keeping sessions engaging and supportive.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            More advanced training for players looking to compete or take their
