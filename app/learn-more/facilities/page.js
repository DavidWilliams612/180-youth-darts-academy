    ...
    <div className="min-h-screen w-full bg-180 flex flex-col text-white">
      ...
      <div className="w-full bg-black/20 border-b border-brand/20 backdrop-blur-sm">
        <div className="px-6 py-3 flex gap-6 text-sm text-white/70 overflow-x-auto">
          ...
          <a href="/learn-more/facilities" className="text-brand-light drop-shadow-[var(--brand-glow)]">
            Facilities
          </a>
      ...
      <header className="px-6 py-16 text-center">
        ...
        <p className="text-white/70 mt-4 max-w-2xl mx-auto">
          Our training environment is designed to support players at every level.
        </p>
      </header>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20 space-y-12">
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            High‑quality boards and lighting ensure players train in competition‑ready conditions.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            Our venue is arranged to give players room to practice safely and confidently.
          </p>
        </section>
